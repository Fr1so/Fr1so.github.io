...
export default class AreaHandler {
    constructor() {
        // Griftsteede POIS
        const griftsteede1 = new POI([5.128442, 52.101841], 20, new POIContent('Vogelhuisje', audioStop1, birdhouse, 'Welk dier leeft hier?', ['Uil', 'Mees', 'Merel', 'Muis'], 1, 'Vogelpotten zoals deze worden al sinds de 16e eeuw gebruikt. Kleine vogels zoals mezen en mussen kunnen hier nestelen of schuilen tegen slecht weer.'), true);
